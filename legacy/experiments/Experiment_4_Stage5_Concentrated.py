...
def Experiment_4(cluster_Count, cluster_Position_Array, cluster_Scale_Array, shape_Scale_Array, shape_List, rotation_List):
    # create file paths
    ...
    guide_Box_1 = shapely.geometry.box(0, 0, Slot_Size_x / 2, Slot_Size_Y / 2)
    colour_Conductor_Helper(guide_Box_1, "NONE", ax)

    guide_Box_2 = shapely.geometry.box(0, 0, Slot_Size_x / 2, Slot_Size_Y / 2)
    guide_Box_2 = move_Grid_Shape(guide_Box_2, 12.5, 0)
    colour_Conductor_Helper(guide_Box_2, "NONE", ax)

    guide_Box_3 = shapely.geometry.box(0, 0, Slot_Size_x / 2, Slot_Size_Y / 2)
    guide_Box_3 = move_Grid_Shape(guide_Box_3, 0, 10)
    colour_Conductor_Helper(guide_Box_3, "NONE", ax)

    guide_Box_4 = shapely.geometry.box(0, 0, Slot_Size_x / 2, Slot_Size_Y / 2)
    guide_Box_4 = move_Grid_Shape(guide_Box_4, 12.5, 10)
    ...
    for x in range(len(grid_Array)):
        # 1 = Square, 2 = Circle, 3 = Triangle, 4 = Hexagon
        ...
        if shape_List[x] == 3:  # is "Triangle" ***
            ...
            conductor_ = move_Conductor(conductor_, grid_Array[x].centroid.x,
                                        (grid_Array[x].centroid.y - (shape_Scale_Array[x] * 0.15)))  # this might need changed back to 0.0535
    ...
    excel_Tool.write_Coil_To_Excel_Experiment_Version(shape_Array, conductor_Array, shape_Scale_Array, None, coil_Weight, fill_Factor, machine_Efficiency, machine_Losses, new_Directory, slot_Configuration)
