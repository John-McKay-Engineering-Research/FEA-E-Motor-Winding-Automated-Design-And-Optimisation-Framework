...
def Experiment_3(layer_Count, layer_Array, shape_List):
    # create file paths
    ...
    for x in range(len(grid_Array)):
        ...
        if shape_List[x] == 3:  # is "Triangle" ***
            ...
            conductor_ = move_Conductor(conductor_, grid_Array[x].centroid.x, (grid_Array[x].centroid.y - (scale_Array[x] * 0.0535)))
