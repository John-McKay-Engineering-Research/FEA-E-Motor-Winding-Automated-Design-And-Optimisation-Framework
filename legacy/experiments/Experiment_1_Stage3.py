...
def Experiment_1(scale_Array, shape_List, x_Position_Array, y_Position_Array):
    # create file paths
    ...
    if Is_Orderly_Test_2 == True:
        ...
        for x1 in range(len(grid_Array)):
            ...
            if shape_List[x1] == 3:  # "Triangle"
                # had to add in a correction as scaling warps the triangle centroid position 0.0535
                conductor_ = move_Conductor(conductor_, x_Position_Array[x1], (y_Position_Array[x1] - (scale_Array[x1] * 0.0535)))
            else:
