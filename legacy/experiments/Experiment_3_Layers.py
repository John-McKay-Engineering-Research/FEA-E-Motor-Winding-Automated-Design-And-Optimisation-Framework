...
def Experiment_3():
    ...
    # for test use add the layer sizes here.
    ...
    global conductor_Array_1 # define as global so we can access variable set in script
    ...
    get_Losses = excel_Tool.read_Losses_Data() # in watts
    get_Torque = excel_Tool.read_Torque_Data() # in nm
    ...
    machine_Losses = get_Losses - 3000 # in watts # could calibrate by taking 3000 watts off, for every 1kw we save roughly 1 %
