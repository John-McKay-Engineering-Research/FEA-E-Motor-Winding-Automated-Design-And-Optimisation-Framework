...
fill_Factor = 100 # calculate this
...
def check_Slot_Contains_Conductor(conductor):
...
def seek_Conductor_Resting_Place(conductor_List):
        ...
        while conductor_In_Slot_Helper(slot, conductor_) == False:
            ...
            for y in range(len(list_Of_Points)):
                ...
                if conductor_In_Slot_Helper(slot, conductor_) == True:
                    colour_Conductor_Helper(conductor_, "BLUE")
                    break
...
def colour_Conductor_Helper(conductor, colour):
...
def colour_Conductor(conductor):
    # applies a patch of colour or a polygonpatch to the shape which represents the conductor.
    # this allows it to be seen on the graph.
    # print("conductor being coloured is " + str(conductor))
...
def Experiment_3(layer_Count, layer_Array, shape_List, scale_List, x_Position, y_Position):
    ...
    for z in range(layer_Count):
        ...
        # layer_Size_Array.append(0.60)
        # layer_Size_Array.append(0.10)
        # layer_Size_Array.append(0.25)
        # layer_Size_Array.append(0.05)
        ...
        for x in range(len(layer_Size_Array)):
            ...
            for y in range(number_Of_Rows):
                ...
                while x_Counter < number_Of_Cols:
                    ...
                    colour_Conductor_Helper(grid_Shape, "NONE")
    ...
    for x in range(len(grid_Array)):
        ...
        conductor_Scale = scale_List[x]  # scale the conductor according to the scale list provided
        ...
        colour_Conductor(conductor_) # colour the conductor yellow0
