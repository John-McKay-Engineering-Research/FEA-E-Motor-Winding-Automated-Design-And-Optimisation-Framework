...
def Experiment_3(layer_Count, layer_Array, shape_List, scale_List, x_Position, y_Position):
    # create file paths
    ...
    for x in range(len(grid_Array)):
        ...
        if shape_List[x] == 3:  # is "Triangle" ***
            ...
            conductor_ = move_Conductor(conductor_, x_Position[x], (grid_Array[x].centroid.y - (scale_List[x] * 0.0535)))
    ...
    excel_Tool.write_Coil_To_Excel_Experiment_Version(shape_Array, conductor_Array, scale_Array, None, coil_Weight,
