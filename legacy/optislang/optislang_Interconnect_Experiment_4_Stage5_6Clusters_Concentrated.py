import Experiment_4_Stage5_6Clusters_Concentrated
...
cluster_4_Position = shapely.geometry.Point(4.1666, 14.06)
cluster_5_Position = shapely.geometry.Point(12.4966, 14.048)
cluster_6_Position = shapely.geometry.Point(20.83266, 13.9371)
...
get_Values = Experiment_4_Stage5_6Clusters_Concentrated
motor_Values = get_Values.Experiment_4(cluster_Count, cluster_Position_Array, cluster_Scale_Array, shape_Scale_Array, cluster_Chosen_Conductor_Positions_Array, shape_Array, rotation_Array)
